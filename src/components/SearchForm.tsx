...
export default function SearchForm() {
    ...
    const { refetch, isLoading } = useQuery({
        queryFn: () => getUserByHandle(slugify(handle)),
    ...
    return (
        <form
            ...
            <div className="mt-10">
                ...
                {isAbleToSign && 
                    <p className="text-center text-cyan-600 font-bold">The username {handle} is available / Go to <Link to={'/auth/register'} className="font-black underline" state={{handle}}>Sign up</Link> </p>
                }
